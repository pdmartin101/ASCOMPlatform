...
namespace ASCOM.DynamicRemoteClients
{
    ...
    public class CameraBaseClass : ReferenceCountedObjectBase, ICameraV3
    {
        ...
        public object ImageArray
        {
            ...
            {
                DynamicClientDriver.SetClientTimeout(client, longDeviceResponseTimeout);
                return DynamicClientDriver.GetValue<Array>(clientNumber, client, URIBase, TL, nameof(ImageArray), imageArrayTransferType, imageArrayCompression, MemberTypes.Property);
            }
        }
