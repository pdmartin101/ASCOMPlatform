...
{
    public class TraceLoggerPlus : ASCOM.Tools.TraceLogger, IDisposable //TraceLogger
    {
        ...
        public TraceLoggerPlus(string fileName, string logName) : base(fileName, "", logName, false)
        {
        ...
        public void LogMessageCrLf(string prefix, string message)
        {
            base.LogMessage(prefix, message);
        }
