...
namespace ASCOM.DynamicRemoteClients
{
    public partial class SetupDialogForm : Form
    {
        ...
        Regex validHostnameRegex = new Regex(AlpacaConstants2.ValidHostnameRegex, RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        private void SetupDialogForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CmbImageArrayTransferType.SelectedItem == null) CmbImageArrayTransferType.SelectedItem = AlpacaConstants2.IMAGE_ARRAY_TRANSFER_TYPE_DEFAULT;
                if (cmbImageArrayCompression.SelectedItem == null) cmbImageArrayCompression.SelectedItem = AlpacaConstants2.IMAGE_ARRAY_COMPRESSION_DEFAULT;
        ...
        private void PopulateAddressList()
        {
            ...
            if (RadIpV4.Checked | RadIpV4AndV6.Checked) // IPv4 addresses are required
            {
                ...
                addressList.Items.Add(AlpacaConstants2.LOCALHOST_NAME_IPV4); // Make "localhost" the first entry in the list of IPv4 addresses
            ...
            if (IPAddressString != AlpacaConstants2.STRONG_WILDCARD_NAME) addressList.Items.Add(AlpacaConstants2.STRONG_WILDCARD_NAME);
